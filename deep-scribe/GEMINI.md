...
* **`src/`**: React Frontend source.
  * `components/`: UI components organized by feature.
    * `Navigation/`: Breadcrumb navigation logic
    * `Editor/`: Pro Tiptap editor
    * `Research/`: 3-pass research dashboard
...
* **Navigation:** Clean, Breadcrumb-based header navigation (no sidebar).
